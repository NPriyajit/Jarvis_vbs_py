...
CreateObject("WScript.shell").Run "C:\Users\Hp\Desktop\jarvis\sound.vbs"
WScript.sleep(10000)
...
if (ping("1.1.1.1")) then
    ...
    WshS.Run chr(34) & "C:\Users\Hp\Desktop\jarvis\rainmeteropener.bat" & Chr(34), 0
    Set WshS = Nothing
    sp.Speak "Hello Mr. N Priyajit, what do you want ,  Jarvis or Friday"
	'iron=inputbox("input jarvis or friday","Iron man")
     ws.run chr(34) & "C:\Users\HP\Desktop\jarvis\speakopener.bat" & chr(34),0
     set ws=Nothing
	WScript.sleep(10200)
	sapi.Speak "recognizing your voice, just wait a moment"
	...
	if iron= "jarvis" or iron="Jarvis" or iron="JARVIS" then
	...
	elseif iron="friday" or iron="Friday" or iron="FRIDAY" then
	set sapi.voice= sapi.GetVoices.Item(1)
	Set WshShe = CreateObject("WScript.Shell") 
    WshShe.Run chr(34) & "C:\Users\Hp\Desktop\jarvis\rainmeteropener.bat" & Chr(34), 0
    Set WshShe = Nothing
	sapi.Speak " Welcome my boss, Hii i am Friday , how can i help you"
	sapi.Speak"say something like open control pannel or something about you excetra excetra, or you can just say help for more commands"
	sapi.Speak " say quit to exit"
	do
	 set wis=CreateObject("WScript.Shell")
     wis.run chr(34) & "C:\Users\HP\Desktop\jarvis\speakopener.bat" & chr(34),0
     set ws=Nothing
	 WScript.sleep(10200)
	 set fso=CreateObject("Scripting.FileSystemObject")
	 set oFile= fso.OpenTextFile("C:\Python27\speechtext.txt",1)
	 msg1=oFile.ReadLine
	 WScript.sleep(4000)
	  if msg1="quit" or msg1="Quit" or msg1="QUIT" Then
	  sapi.Speak "we are quiting , good bye.."
	  CreateObject("wscript.shell").Run "taskkill /F /IM wscript.exe /T" 
	  end if  
	 speak(msg1)
	...
	loop until IsEmpty(msg1)
	 ...
	 sp.Speak"hey! you entered a differnt name, please check it or re-enter it"
	end if
